...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative h-screen flex items-center bg-gradient-to-r from-gray-50 to-blue-50"
    >
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="hidden md:block animate-fade-in-up">
            <img
              src="https://images.unsplash.com/photo-1612014207052-56f7b5584d0e?q=80&w=2070"
              alt="Embalagens de qualidade"
